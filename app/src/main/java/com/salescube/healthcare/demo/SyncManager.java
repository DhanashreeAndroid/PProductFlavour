...
public class SyncManager extends AsyncTask<Object, String, Boolean> {
    ...
    public SyncManager(Context context, Handler pHandler, boolean _fullDownload) {
    ...
    private Boolean downloadTodaysOrderSO() {
        ...
        int employeeId = AppControl.getmEmployeeId();
        Call<SalesOrder[]> call = apiService.getTodayOrderSO(employeeId);

        try {
            retrofit2.Response<SalesOrder[]> response = call.execute();
            ...
            if (response.isSuccessful()) {
                ...
                SalesOrder[] objList = response.body();


                objObjData.insert(objList);

            }else {
                // nHandler.error(response.errorBody().string());
            }
        } catch (Exception e) {
            // logException(e);
        }
   ...
   /* private Boolean downloadTodaysOrderSO() {
    ...
    private Boolean downloadSO() {
        ...
        int employeeId = AppControl.getmEmployeeId();
        Call<Employee[]> call = apiService.getSOByManagerId(employeeId);

        try {
            retrofit2.Response<Employee[]> response = call.execute();
            ...
            if (response.isSuccessful()) {
                ...
                Employee[] objList = response.body();
...
//    }
    ...
    private Boolean downloadShops() {
        ...
        int employeeId = AppControl.getmEmployeeId();
        Call<Shop[]> call = apiService.getShops(employeeId);

        try {
            retrofit2.Response<Shop[]> response = call.execute();
            ...
            if (response.isSuccessful()) {
                ...
                Shop[] forms = response.body();

                new ShopRepo().deleteAll(employeeId);
                objShopData.insert(forms);
 ...
 /*   private Boolean downloadShops() throws Exception {
    ...
    private Boolean downloadProducts() {
        ...
        int employeeId = AppControl.getmEmployeeId();
        Call<Product[]> call = apiService.getProductsbySo(employeeId);
        ...
        try {
            ...
            if (response.isSuccessful()) {
                ...
                Product[] forms = response.body();

                objProductData.deleteAll(employeeId);
                objProductData.insert(forms);
 ...
 /*   private Boolean downloadProducts() throws Exception {
    ...
    private Boolean downloadPriceList() {
        ...
        int employeeId = AppControl.getmEmployeeId();
        Call<ProductRate[]> call = apiService.getPriceList(employeeId);

        try {
            retrofit2.Response<ProductRate[]> response = call.execute();
            ...
            if (response.isSuccessful()) {
                ...
                ProductRate[] forms = response.body();

                objPriceList.deleteAll(AppControl.getmEmployeeId());
                objPriceList.insert(forms);
    ...
    private Boolean downloadTargetAndFocus() {
        ...
        int employeeId = AppControl.getmEmployeeId();
        Date date = AppControl.getTodayDate();

        String todaysDate = DateFunc.getDateStr(date);
        Call<Target[]> call = apiService.getTargetList(employeeId,todaysDate);

        try {
            retrofit2.Response<Target[]> response = call.execute();

            if (response.isSuccessful()) {


                Target[] targets = response.body();
  ...
  /*  private Boolean downloadTargetAndFocus() throws Exception {
    ...
    private Boolean downloadNotes() {
        ...
        Call<Note[]> call = apiService.getNotes(employeeId);

        try {
            retrofit2.Response<Note[]> response = call.execute();

            if (response.isSuccessful()) {


                Note[] targets = response.body();
 ...
 /*   private Boolean downloadNotes() throws Exception {
    ...
    private Boolean downloadPreviousOrders() {
        ...
        Call< List<SalesOrderPrevious>> call = apiService.getLastOrdersBySo(employeeId);

        try {
            retrofit2.Response< List<SalesOrderPrevious>> response = call.execute();

            if (response.isSuccessful()) {


                List<SalesOrderPrevious>  targets = response.body();
   ...
   /* private Boolean downloadPreviousOrders() throws Exception {
    ...
    private Boolean downloadPOP() {
        ...
        Call<POP[]> call = apiService.getPOPBySO(employeeId);

        try {
            retrofit2.Response< POP[]> response = call.execute();

            if (response.isSuccessful()) {

                POP[]  list = response.body();
  ...
  /*  private Boolean downloadPOP() throws Exception {
    ...
    private Boolean downloadShopTypes() {
        ...
        Call<ShopType[]> call = apiService.getShopType(employeeId);

        try {
            retrofit2.Response< ShopType[]> response = call.execute();

            if (response.isSuccessful()) {

                publishProgress(String.format("%s (%s)...", "Downloading Shop Types", count));
                ShopType[]  list = response.body();
    ...
    private Boolean downloadOtherWorkReason() {
        ...
        Call<OtherWorkReason[]> call = apiService.getOtherWorkReason(employeeId);

        try {
            retrofit2.Response< OtherWorkReason[]> response = call.execute();

            if (response.isSuccessful()) {

                publishProgress(String.format("%s (%s)...", "Downloading Work Reason", count));
                OtherWorkReason[]  list = response.body();
    ...
    private Boolean downloadSS() {
        ...
        Call<SS[]> call = apiService.getSS(employeeId);

        try {
            retrofit2.Response< SS[]> response = call.execute();

            if (response.isSuccessful()) {

                publishProgress(String.format("%s (%s)...", "Downloading SS List", count));
                SS[]  list = response.body();
...
//    }
    ...
    private Boolean downloadComplaintType() {
        ...
        Call<ComplaintType[]> call = apiService.getComplaintType(employeeId);

        try {
            retrofit2.Response< ComplaintType[]> response = call.execute();

            if (response.isSuccessful()) {

                publishProgress("Downloading complaint types");
                ComplaintType[]  list = response.body();
...
/*    private Boolean downloadComplaintType() {
    ...
    private Boolean downloadAgentsMain() {
        ...
        Call<Agent[]> call = apiService.getallList(employeeId);

        try {
            retrofit2.Response< Agent[]> response = call.execute();

            if (response.isSuccessful()) {

                publishProgress(String.format("%s (%s)...", "Downloading Agents New", count));
                Agent[]  list = response.body();
...
/*    private Boolean downloadAgentsMain() {
    ...
    private Boolean downloadArea() {
        ...
        Call<Area[]> call = apiService.getAreas(employeeId);

        try {
            retrofit2.Response< Area[]> response = call.execute();

            if (response.isSuccessful()) {

                publishProgress(String.format("%s (%s)...", "Downloading Areas", count));
                Area[]  list = response.body();
...
/*    private Boolean downloadArea() {
    ...
    private Boolean downloadRoute() {
        ...
        Call<Route[]> call = apiService.getRoute(employeeId);

        try {
            retrofit2.Response< Route[]> response = call.execute();

            if (response.isSuccessful()) {

                publishProgress(String.format("%s (%s)...", "Downloading Route", count));
                Route[]  list = response.body();
...
*/
    ...
    private Boolean downloadLocality() {
        ...
        Call<Locality[]> call = apiService.getLocality(employeeId);

        try {
            retrofit2.Response< Locality[]> response = call.execute();

            if (response.isSuccessful()) {

                publishProgress(String.format("%s (%s)...", "Downloading Route", count));
                Locality[]  list = response.body();
   ...
   /* private Boolean downloadLocality() throws Exception {
    ...
    private Boolean downloadAreaAgent() {
        ...
        Call<AreaAgent[]> call = apiService.getRLAreaAgent(employeeId);

        try {
            retrofit2.Response< AreaAgent[]> response = call.execute();

            if (response.isSuccessful()) {

                publishProgress(String.format("%s (%s)...", "Downloading Area to Agent", count));
                AreaAgent[]  list = response.body();
