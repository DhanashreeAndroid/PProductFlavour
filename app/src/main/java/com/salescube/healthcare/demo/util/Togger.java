package com.salescube.healthcare.demo.util;
...
public class Togger {
     ...
     */
    public static Togger getLogger() {
     ...
     * @param msg
     * @param depth
     * @see com.salescube.healthcare.demo.util.Togger.LOGGER_DEPTH
     */
    ...
    public void e(Throwable t) {
        try {
            Log.e(getTag(LOGGER_DEPTH.ACTUAL_METHOD), "", t);
    ...
    public void e(Throwable t, String msg ) {
        try {
            Log.e(getTag(LOGGER_DEPTH.ACTUAL_METHOD), msg, t);
        } catch (Exception exception) {
            Log.e(getTag(LOGGER_DEPTH.ACTUAL_METHOD), "Logger failed, exception: " + exception.getMessage());
        }
    }
    ...
    private static class LoggerLoader {
        private static final Togger instance = new Togger();
    }
}
