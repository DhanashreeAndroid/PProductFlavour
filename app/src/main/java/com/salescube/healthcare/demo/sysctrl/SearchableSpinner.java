...
public class SearchableSpinner extends AppCompatSpinner implements View.OnTouchListener,
    ...
    protected List<SearchableSpinnerTouchListener> touchListeners = new ArrayList<>();
    ...
    public interface SearchableSpinnerTouchListener extends EventListener {
         void onTouch();
    }

    public void addOnTouchListener(SearchableSpinnerTouchListener listener) {
        touchListeners.add(listener);
    }

    public  void setOnTouch() {
        for ( SearchableSpinnerTouchListener listener: touchListeners  ) {
            listener.onTouch();
        }
    }
